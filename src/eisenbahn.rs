...
impl Plugin for EisenbahnPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_system(update_selection_system.run_if(resource_exists::<UpdateSelection>()));
        app.add_system(remove_selection_system.run_if(resource_exists::<RemoveSelection>()));
    }
}
